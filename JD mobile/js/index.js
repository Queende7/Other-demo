...
var search = function(){
    ...
    window.onscroll = function(){
        ...
        if(top > height){
            ...
            search.style.background  = "rgba(201,21,35,"+top+")";
        }
    };
};
/*秒杀倒计时*/
...
var scrollPic = function() {
    ...
    var index = 0; // 存放 轮播图片的 张数。
    var square = 0; // 控制 ul 小圆点。
    ...
    function setTransform(t) {
        ...
        imgBox.style.webkitTransform = "translateX("+t+"px)"; // 解决兼容性
    }
    // 定时器
    timer = setInterval(function() {
        index++;
    ...
    imgBox.addEventListener("transitionend",function(){
        ...
        pointList[square].className = "now";

        removeTransition();
        setTransform(-index*width);
    },false); // 第三个参数：false防止从里到外冒泡。
